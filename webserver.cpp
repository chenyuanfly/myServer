...
{
    //std::cout << "in dealclientdata !!!" << std::endl;
...
void WebServer::dealwithread(int sockfd)
{
    ...
    else
    {
        ...
        //std::cout << "out deal with the client!!!" << std::endl;
    }
}
...
void WebServer::eventLoop()
{
    ...
    while(!stop_server)
    {
        ...
        for(int i = 0; i < number; i++)
        {
            ...
            {
                //std::cout << "in m_listenfd !!!" << std::endl;
            ...
            {
                //std::cout << "in 接收到的数据 !!!" << std::endl;
                dealwithread(sockfd);
            }
            else if(events[i].events &EPOLLOUT)
            {
                //std::cout << "in 发送到的数据 !!!" << std::endl;
